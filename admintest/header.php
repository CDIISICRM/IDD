...
<table width="100%" border="1" cellspacing="0" cellpadding="3" bordercolor="#000000">
  ...
  <tr>
    ...
    <td valign="top"><center><font size="1"><strong><a href="http://www.mcda-asso.com" alt="http://www.mcda-asso.com" target="_blank">Voir le site</a>&nbsp|&nbsp <a href="index.php">Accueil administration</a>&nbsp;|&nbsp;<a href="index.php?controller=Login&action=FinSession"><h3>Déconnexion</a></h3><br> <hr color="black"></strong></font></center><br><br>
